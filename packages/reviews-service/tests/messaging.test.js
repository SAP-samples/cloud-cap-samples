...
describe('messaging tests', ()=>{
    ...
    it ('should add more reviews', ()=> Promise.all ([
        // REVISIT: srv.create should support mass operations
        // srv.run (INSERT.into ('Reviews') .entries (  // FIXME: --> sql error unknown
        // srv.run (INSERT.into ('sap.capire.reviews.Reviews') .entries ( // FIXME: --> The server does not fulfill the functionality ...
